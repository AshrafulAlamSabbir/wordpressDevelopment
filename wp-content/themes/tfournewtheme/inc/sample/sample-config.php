...
$args = array(
	...
	'menu_title'                => esc_html__( 'coretheme Options', 'your-textdomain-here' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'coretheme Options', 'your-textdomain-here' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Logo ', 'tfournewtheme' ),
		'id'               => 'logo',
		'desc'             => esc_html__( 'change your logo!', 'tfournewtheme' ),
		...
		'fields'           => array(
         ...
         array(
                 'id'               => 'header_logo',
                 'type'             => 'media',
		         'title'             => esc_html__( 'Header Logo', 'tfournewtheme' ),
		         'desc'             => esc_html__( 'change your logo!', 'tfournewtheme' ),
         ),
           ...
           array(
                 'id'               => 'footer_logo',
                 'type'             => 'media',
		         'title'             => esc_html__( 'Footer Logo', 'tfournewtheme' ),
		         'desc'             => esc_html__( 'change your logo!', 'tfournewtheme' ),
         ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Header ', 'tfournewtheme' ),
		'id'               => 'header',
		'desc'             => esc_html__( 'change your header part!', 'tfournewtheme' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-dribbble',
		'fields'           => array(
         ...
         array(
                 'id'               => 'header_title',
                 'type'             => 'text',
		         'title'             => esc_html__( 'Header Title', 'tfournewtheme' ),
		         'desc'             => esc_html__( 'change your header part!', 'tfournewtheme' ),
         ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Social Links ', 'tfournewtheme' ),
		'id'               => 's_links',
		'desc'             => esc_html__( 'change your social link part!', 'tfournewtheme' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-dribbble',
		'fields'           => array(
         ...
         array(
                 'id'               => 'facebook',
                 'type'             => 'text',
		         'title'             => esc_html__( 'Facebook Link', 'tfournewtheme' ),
		        
         ),
           array(
                 'id'               => 'twitter',
                 'type'             => 'text',
		         'title'             => esc_html__( 'Twitter Link', 'tfournewtheme' ),
		        
         ),
             array(
                 'id'               => 'dribbble',
                 'type'             => 'text',
		         'title'             => esc_html__( 'Dribbble Link', 'tfournewtheme' ),
		        
         ),
              array(
                 'id'               => 'behance',
                 'type'             => 'text',
		         'title'             => esc_html__( 'Behance Link', 'tfournewtheme' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Footer ', 'tfournewtheme' ),
		'id'               => 'footer',
		'desc'             => esc_html__( 'change your footer part!', 'tfournewtheme' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-dribbble',
		'fields'           => array(
         ...
         array(
                 'id'               => 'copyright',
                'type'             => 'text',
		         'title'             => esc_html__( 'Footer copyright', 'tfournewtheme' ),
		         'desc'             => esc_html__( 'change your footer part!', 'tfournewtheme' ),
         ),
